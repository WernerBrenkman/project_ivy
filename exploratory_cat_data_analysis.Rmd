...
The transformation of the categorical varibles are enclosed in the **transform.R source** code.
...
```{r, echo = FALSE, warning = FALSE}
N1 = ggplot(train1, aes(x = Neighborhood)) + geom_histogram(stat = 'count') +
