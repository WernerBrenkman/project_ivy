...
The transformation of the categorical varibles are enclosed in the transform.R source code. A summary of the transformation is here. All Quality variables had the same ordered levels that ranked the quality of the feature from None to Excellent, these features were lanel encoded to the equaivalent numeric level. 
...
Let's explore the neighborhood feeatures.
